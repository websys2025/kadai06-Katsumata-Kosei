...
APP_ID = "79179da432aa1a5790a0a4778f0d120f12321a65"
...
for class_obj in meta_info:
    ...
    #　統計データの列名を「@code」から「@name」の置換するディレクショナリを作成
